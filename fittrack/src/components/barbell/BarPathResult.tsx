...
interface Props {
  ...
  videoHeight?: number;
  /**
   * Object URL of the analyzed video. Present only for a freshly analyzed lift
   * (saved history sessions don't store the video). When null, only the static
   * "Path" view is shown — no toggle.
   */
